...
- macOS Runtime API Keys are stored in Keychain. Secret bytes are sent to the `security` password prompt through stdin and are never encoded into a command-line argument.
