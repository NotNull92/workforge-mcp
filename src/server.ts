...
function serverInstructions(context: ProjectContext): string {
  ...
  return [
    ...
    "The filesystem and shell tools run as the current OS user and can reach unrelated workstation paths, except roots assigned to another registered profile.",
