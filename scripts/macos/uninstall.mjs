...
import { deleteStoredControlPlaneKey } from "./tunnel-common.mjs";
...
const supportState = resolve(supportRoot, "current.json");
...
if (whatIf) {
  ...
  console.log(`Remove the stored Runtime API Key and tunnel runtime state for: ${profileId}`);
...
rmSync(resolve(supportRoot, "tunnel", profileId), { recursive: true, force: true });
